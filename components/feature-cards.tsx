      ...
      <div className="max-w-[1120px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {cards.map(({ Icon, title, desc, facts, featured }) => (
            <article
              key={title}
              className={`group relative rounded-3xl p-7 transition-all duration-300 ${featured
                  ? "bg-gradient-to-br from-[#e0f7fa] via-white to-white ring-1 ring-accent/25 shadow-[0_30px_60px_-35px_rgba(26,188,217,0.45)] hover:shadow-[0_40px_70px_-30px_rgba(26,188,217,0.55)]"
            ...
            >
              ...
              <div
                className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-5 ${featured
                    ? "bg-accent text-white shadow-[0_8px_20px_-6px_rgba(26,188,217,0.55)]"
        ...
        <div className="mt-7 relative overflow-hidden rounded-3xl bg-black text-white p-8 sm:p-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div
            ...
            style={{
              background:
                "radial-gradient(900px 300px at 90% 0%, rgba(26,188,217,0.35), transparent 60%), radial-gradient(600px 260px at 0% 100%, rgba(23,151,172,0.25), transparent 60%)",
            }}
          />
          <div className="relative max-w-[560px]">
            <div className="text-[11px] font-bold tracking-[1.5px] uppercase text-[#95d9e8] font-mono mb-3">
              See it live
            </div>
          ...
          <a
            href="#"
            className="group inline-flex items-center gap-2 bg-accent text-white text-[15px] font-semibold font-mono pl-7 pr-3 py-2 rounded-full hover:bg-[color:var(--accent-dark)] shadow-[0_8px_24px_-6px_rgba(26,188,217,0.45)] self-start lg:self-auto"
          >
            Request a Demo
