...
function CounterCell({ stat, start }: { stat: Stat; start: boolean }) {
  ...
  return (
    <div className="relative rounded-3xl bg-white/5 ring-1 ring-white/10 backdrop-blur-sm p-8 flex flex-col gap-2 overflow-hidden">
      ...
      />
      <span className="relative text-5xl md:text-6xl font-semibold text-[#95d9e8] font-serif tabular-nums leading-none">
        {value}
        {stat.suffix}
      </span>
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(800px 400px at 20% 0%, rgba(26,188,217,0.35), transparent 60%), radial-gradient(600px 400px at 90% 100%, rgba(23,151,172,0.25), transparent 60%)",
        }}
      />
      <div className="relative max-w-[1040px] mx-auto">
        <p className="text-xs font-bold tracking-[1.5px] uppercase text-[#95d9e8] mb-3 font-mono">
